...
if (isset($_SESSION['user_id']) === TRUE) {
   ...
   header('Location: http://www.shunichiro.jp/login_test/htdocs/session_sample_top.php');
   exit;
}
// データベース接続
$link = get_db_connect();
...
if (isset($data[0]['user_name'])) {
  ...
  header('Location: http://www.shunichiro.jp/login_test/htdocs/session_sample_logout.php');
  exit;
}

// ログイン済みユーザのホームページ表示
include_once '../include/view/session_sample_home.html';